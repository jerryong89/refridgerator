    ...
    return (
      <div>
        ...
        <div className="container d-flex justify-content-center test">
          <div className="col-10 d-flex justify-content-center align-items-center cursive-font mt-4">
            <form>
              <div className="mt-4">
                <p className="add-food-font">Food Name:</p>
                <input type="text" className="w-100 add-food-font-size" onChange={this.handleFoodNameInput}/>
              </div>
              <div className="mt-4">
                <p className="add-food-font">Food Group:</p>
                <select name="food-groups" id="food-groups" className="food-group-dropdown w-100 add-food-font-size" onChange={this.handleFoodGroupInput}>
              ...
              <div className="mt-4">
                ...
                <input type="number" className="w-25 add-food-font-size" onChange={this.handleQuantityInput}/>
              </div>
              <div className="mt-4">
                <p className="add-food-font">Expiration Date:</p>
                <input type="date" className="w-100 add-food-font-size" onChange={this.handleDateInput} />
              </div>
              <div className="mt-4">
